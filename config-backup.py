...
layouts = [
    layout.MonadTall(margin = 10, border_width = 1, border_focus="#03c03c", border_normal="#4c566a"),
    layout.MonadWide(margin = 5, border_width = 2, border_focus="#03c03c", border_normal="#4c566a"),
    layout.Matrix(margin = 5, border_width = 2, border_focus="#03c03c", border_normal="#4c566a"),
